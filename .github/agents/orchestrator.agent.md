...
- **Planner** — Creates implementation strategies and technical plans for general purposes
- **Angular Coder** — This is Coder agent. Expert in Angular and TypeScript, implements tasks following best practices
...
### Phase 1: [Name]
- Task 1.1: [description] → Angular Coder
...
- Task 2.1: [description] → Angular Coder
  Files: src/App.tsx
```
